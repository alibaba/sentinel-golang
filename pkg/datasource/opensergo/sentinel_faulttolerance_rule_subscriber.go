...
func (s FaultToleranceRuleSubscriber) OnSubscribeDataUpdate(subscribeKey model.SubscribeKey, data interface{}) (bool, error) {
	...
	return s.opensergoRuleAggregator.updateFaultToleranceRules(messages)
}
