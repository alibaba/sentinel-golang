...
import (
	...
	"github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/internal/profiling/buffer"
)
...
// initialization with github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/profiling/service.ProfilingConfig
