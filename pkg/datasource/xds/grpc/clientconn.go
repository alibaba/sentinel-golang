...
import (
	...
	"github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/balancer"
	"github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/balancer/base"
	"github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/codes"
	"github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/connectivity"
	"github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/credentials"
	"github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/internal/backoff"
	"github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/internal/channelz"
	"github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/internal/grpcsync"
	"github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/internal/pretty"
	iresolver "github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/internal/resolver"
	"github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/internal/transport"
	"github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/keepalive"
	"github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/resolver"
	"github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/serviceconfig"
	"github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/status"

	_ "github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/balancer/roundrobin"           // To register roundrobin.
	_ "github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/internal/resolver/dns"         // To register dns resolver.
	_ "github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/internal/resolver/passthrough" // To register passthrough resolver.
	_ "github.com/alibaba/sentinel-golang/pkg/datasource/xds/grpc/internal/resolver/unix"        // To register unix resolver.
)
