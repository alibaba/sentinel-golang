...
import (
	...
	envoy_admin_v3 "github.com/alibaba/sentinel-golang/pkg/datasource/xds/go-control-plane/envoy/admin/v3"
	envoy_config_cluster_v3 "github.com/alibaba/sentinel-golang/pkg/datasource/xds/go-control-plane/envoy/config/cluster/v3"
	envoy_config_core_v3 "github.com/alibaba/sentinel-golang/pkg/datasource/xds/go-control-plane/envoy/config/core/v3"
	envoy_config_listener_v3 "github.com/alibaba/sentinel-golang/pkg/datasource/xds/go-control-plane/envoy/config/listener/v3"
	envoy_config_route_v3 "github.com/alibaba/sentinel-golang/pkg/datasource/xds/go-control-plane/envoy/config/route/v3"
	...
	http_connection_manager_v3 "github.com/alibaba/sentinel-golang/pkg/datasource/xds/go-control-plane/envoy/extensions/filters/network/http_connection_manager/v3"
