...
func (dc *DefaultController) CanPass(ctx context.Context, node *base.DefaultNode, acquire uint32) bool {
...
func (rlc *RateLimiterController) CanPass(ctx context.Context, node *base.DefaultNode, acquire uint32) bool {
	if acquire < 0 {
		return true
	}
